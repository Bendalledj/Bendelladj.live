! function(e) {
    ...
    */
    ...
    e.exports = JSON.parse('[{"start":"400","end":"700","text":"My name is Muhammed Ashique"},{"start":"700","end":"900","text":"I\'m Security Researcher"},{"start":"1000","end":"1200","text":"Living In Kerala,"},{"start":"1200","end":"1400","text":"Now Iam Doing A Course ,"},{"start":"1600","end":"1800","text":"In REDTEAM HACKER ACADEMY."}]')
}, , function(e, t, n) {
    "use strict";
    ...
    function et(e) {
        return u.a.useEffect((function() {
            ...
            document.querySelector("#contactsbutton").addEventListener("click", (function() {
                window.open("https://www.linkedin.com/in/ashq/")
            }))
        })), u.a.useEffect((function() {
            document.querySelector("#githubbutton").addEventListener("click", (function() {
                window.open("https://www.instagram.com/_ashique___muhammed")
            }))
